...
learningCurveGraph <- visits_data %>%
  ggplot(aes(x = diffTime, y = visits)) +
  geom_line(linewidth = .5) +
  ...
  facet_wrap(vars(swapNumber))
learningCurveGraph
ggsave(here("figures", "learningCurveCompletedRisky.pdf"), width = 16, height = 16)
```
